const projects = [
  {
    ...
    description:
      'This site! A personal brand built around watch reviews, repair guides, and coffee culture. Next.js on Vercel with Neon Postgres.',
    imageUrl: 'https://i.ibb.co/MDZvSN5b/Screenshot-2026-01-06-at-3-53-07-PM.png',
    liveUrl: process.env.NEXT_PUBLIC_SITE_URL || 'https://regul8d-x-caffein8d.vercel.app',
    sourceUrl: 'https://github.com/gonzalorportfolio',
    tags: ['Next.js', 'Vercel', 'Neon', 'React'],
  },
  {
    title: 'Local Tapas',
    description:
